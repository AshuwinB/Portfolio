  ...
  return (
    <>
      ...
      <div className='app__footer-card'>
        ...
        <a href='mailto:ashucoc98765@gmail.com' className='p-text'>ashucoc98765@gmail.com</a>
      </div>
      <div className='app__footer-card'>
        <img src={images.mobile} alt="mobile"/>
        <a href='tel: +91 9508504489' className='p-text'>+91 9508504489</a>
      </div>
      </div>
      ...
      <div className='app__flex'>
        ...
        <button type='button' className='p-text' onClick={handleSubmit}>{loading ? 'Sending' : 'Sent Message'}</button>
    </div>
    : <div>
